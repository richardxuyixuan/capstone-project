...
import classifier 
from classifier import ClassifierFC
...
def img_process(input_image_path, output_image_path, resnet_weights_path, classifier_weights_path):
      '''
      input_image_path: str, path to input ad image
      output_image_path: str, a processed image will be written to output_image
            GIT will read the output_image to generate captions 
      '''
      classes = ['text','text+img','image']
      # read image in RGB channel 
      read_image = Image.open(input_image_path).convert('RGB') 
...
if __name__ == '__main__':
      ...
      classifier_weights_path = "/home/skyler/codebase/year4/fall/mie429/GenerativeImage2Text/classifier"
      input_image_path = "/home/skyler/codebase/year4/fall/mie429/raw_imgs/1_10.png"
      output_image_path = "/home/skyler/codebase/year4/fall/mie429/1_10.png"
      img_process(input_image_path, output_image_path, resnet_weights_path, classifier_weights_path)
